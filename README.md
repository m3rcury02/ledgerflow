...
access, and no cost; two optional real providers are available behind explicit configuration
for anyone who supplies their own key — OpenAI (Responses API) or DeepSeek (Chat Completions
