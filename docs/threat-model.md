...
- Full-flow fixed-trace tests for HTTP/provider/outbox/Kafka parentage, code-enforced metric label allowlists, provisioned dashboard/rule validation, and a failing exporter that cannot change the order/journal/outbox result.
